...
with tf.device('/gpu:3'):
    ...
    pred_notes = Dense(vecLen, kernel_initializer='normal', activation='tanh', name='note_output')(fc_notes) ## output PMF

    fc_delta = BatchNormalization()(encoded)
    pred_delta = Dense(maxdelta, kernel_initializer='normal', activation='tanh', name='time_output')(fc_delta) ## output PMF
